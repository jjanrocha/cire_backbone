<div id="form_controle_escalonamento_crise" class="my-3">
    ...
    <form method="POST" id="carimbo_form" action="#">
        ...
        <button type="submit" id="btnEnviar" class="btn btn-success my-1" onclick="ajax()">Gerar Carimbo</button>
...
<script>
  ...
  http.send("text=Gerado novo registro (Controle - CRISE)&chat_id=-468251232");
}
</script>